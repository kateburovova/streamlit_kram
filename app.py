...
color = "#C2D8AA"
message = 'Кожен з поданих графіків - інтерактивний. Для зміни масштаба скористайтесь типовим жестом "збільшити", при наведенні на відповідну частину графіка ви побачите підказку.'
st.markdown(f"""
