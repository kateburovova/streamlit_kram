...
st.markdown('В першу добу після обстрілу російські Телеграм канали здебільшого мотивували провину України тим, що аналогічну зброю ЗСУ активно використовували при обстрілах так званих ДНР та ЛНР.',
         'Винуватцем подається саме Україна, єдиним виключенням є повідомлення <i>"❗️Прилеты по ж/д Краматорска в эти минуты. Скорее всего работают по скоплению ВСУ в районе завода (КЦШК) и (СКМЗ)."</i> від канала АГС_Донбасса (https://t.me/ags_donbass)')
